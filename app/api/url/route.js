...
// Cette route sert uniquement à obtenir une URL signée de Pinata pour les uploads directs. Elle est utilisée pour les gros fichiers (>100MB)
...
export async function GET() {
  ...
  try {
    const url = await pinata.upload.public.createSignedURL({
      expires: 30, // 30 seconds - recommended for security
    });
