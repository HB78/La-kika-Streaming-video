    ...
    <header className="relative w-full h-[100svh] min-h-[600px] max-h-[900px] text-white overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg, rgba(0,0,0,0.92) 0%, rgba(0,0,0,0.7) 30%, rgba(0,0,0,0.3) 50%, transparent 70%)",
          }}
        />
        {/* Gradient bas */}
        <div
          ...
          style={{
            background:
              "linear-gradient(to top, rgba(0,0,0,0.95) 0%, rgba(0,0,0,0.4) 25%, transparent 50%)",
          }}
        />
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 70% 30%, transparent 30%, rgba(0,0,0,0.8) 100%)",
          }}
        />
      </div>
        ...
        <div className="flex items-center gap-4 mt-5 text-sm text-white/60">
          ...
          {randomMovie?.runtime && (
            <>
              ...
              <span>
                {Math.floor(randomMovie.runtime / 60)}h{" "}
                {randomMovie.runtime % 60}min
              </span>
            </>
          )}
